            ...
            <form onSubmit={handleSaveForm} className="space-y-3.5 text-xs">
              ...
              <div className="p-3.5 bg-gradient-to-br from-[#FAF8F5] via-[#F4F0E6] to-[#EAE4D5] rounded-2xl border border-[#D5CEBF] shadow-xs space-y-2.5">
                ...
                <p className="text-[11px] text-[#5C5852] leading-relaxed">
                  Pilih item belanja resmi BOS Reguler di bawah ini untuk mengisi <strong>Tema</strong>, <strong>Subtema Program</strong>, <strong>Kode Rekening</strong>, <strong>Kode Program</strong>, <strong>Satuan</strong>, dan <strong>Tarif</strong> secara otomatis tanpa perlu mengetik manual.
                </p>
